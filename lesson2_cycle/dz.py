...
#         i_min = i
#     i += 1
# print(f'max = {max}, [{i_max}] min = {min}, [{i_min}]')
...
# lst.remove('рыбка')
#
# print('финальный список', lst)
# print('продуктов в списке', len(lst))
...
# 3) Есть список и число, которое ввел пользователь, посчитать сколько раз это число встречается в списке

# lst = [12, 5, 76, 123, 8, 98, 3, 65, 5, 45, 76, 3, 3, 5, 88, 65]
# a = int(input('введите число : '))
# if a in lst:
#     i = 0
#     s = 0
...
#         if a == _:
#             i += 1
#     print(f'число в списке встречается {i} раз')
# else:
#     print(f'число {a} не в списке')
...
#         else:
#             i += 1
#     print(f'число в списке встречается {s} раз')
# else:
#     print(f'число {a} не в списке')
